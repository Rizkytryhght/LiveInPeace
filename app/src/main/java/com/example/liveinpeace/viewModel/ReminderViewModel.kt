...
//                        if (response.isSuccessful) {
//                            val timings = response.body()?.data?.timings
//                            _dzikirPagiTime.value = timings?.Fajr ?: "N/A"
//                            _dzikirPetangTime.value = timings?.Maghrib ?: "N/A"
//                        } else {
//                            _dzikirPagiTime.value = "Error"
//                            _dzikirPetangTime.value = "Error"
//                        }
//                    }
//
//                    override fun onFailure(call: Call<SalatTimesResponse>, t: Throwable) {
//                        _dzikirPagiTime.value = "Failed"
//                        _dzikirPetangTime.value = "Failed"
//                    }
//                })
//        }
//    }
